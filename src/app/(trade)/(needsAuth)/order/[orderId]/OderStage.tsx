...
function OrderStage({ orderId, toggleExpand }: { orderId: string; toggleExpand: () => void }) {
  ...
  const handlePayOrder = async () => {
    ...
    async function pay() {
      ...
      conversation && sendMessage(conversation, "Paid. Please check and release. TxHash: " + writeResult.txHash);
      return writeResult.txHash;
    }
  };
  ...
  const handleAcceptOrder = async () => {
    ...
    conversation && sendMessage(conversation, "Accepted. Please proceed to pay. TxHash: " + writeResult.txHash);
  };
