              ...
              <div className="flex justify-between mb-6">
                ...
                <div className="flex flex-col items-start gap-8">
                  <div className="flex w-full">
                    <div className="flex flex-col items-center">
                      <div
                        className={` ${isPending ? "bg-primary" : "bg-lightGray dark:bg-lightGray-dark"
                          } text-white rounded-full w-10 h-12 flex items-center justify-center font-bold`}
                      >
                        1
                      </div>
                      <div
                        className={`h-full border-l-2   ${isPending ? "border-primary" : "border-lightGray dark:border-lightGray-dark"
                          }`}
                      ></div>
                    </div>
                ...
                <div className="flex flex-col items-start gap-8">
                  <div className="flex flex-row w-full">
                    <div className="flex flex-col items-center">
                      <div
                        className={` ${isPaid ? "bg-lightGray dark:bg-lightGray-dark" : "bg-primary"
                          } text-white rounded-full w-10 h-12 flex items-center justify-center font-bold`}
                      >
                        2
                      </div>
                      <div
                        className={`h-full border-l-2   ${isPaid ? "border-lightGray dark:border-lightGray-dark" : "border-primary"
                          }`}
                      ></div>
                    </div>
                    <div className="ml-4 flex-grow">
