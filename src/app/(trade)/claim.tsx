...
const claim: React.FC<Props> = ({ className }) => {
  ...
  return (
    <Button
      ...
      className={`bg-gradient-to-r transition duration-300 bg-[#01A2E4] hover:bg-[#0191C8] text-white rounded-xl px-4 py-2 font-bold  border-blue-300 dark:border-blue-600 ${className}`}
