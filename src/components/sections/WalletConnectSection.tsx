    ...
    return (
        <div className="min-h-[300px] flex justify-center items-center">
            <div className="flex flex-col items-center text-center py-10 lg:py-20">
                <h1 className="text-4xl lg:text-[70px] font-semibold mb-4 text-[#111315] dark:text-white">
                    Onchain <span className="gradient-text">P2P</span> Trading Platform
                </h1>
                <p className="text-lg text-[#3D4651] lg:text-[16px] font-semibold mb-8 dark:text-gray-300">
                ...
                <div className="flex flex-row item-center gap-4">
                    {session.status === "authenticated" && (
                        <>
                            <Claim className='w-[170px] hidden lg:block' />
                            <div className="">
                                <NetworkSwitcher />
                            </div>
                        </>
