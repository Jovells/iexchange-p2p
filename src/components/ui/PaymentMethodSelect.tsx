  ...
  return (
    <div className="flex flex-col items-center ">
      <div
        ref={dropdownRef}
        className={
          "relative border border-gray-300 dark:border-gray-600 dark:hover:border-[#01a2e4] hover:border-[#01a2e4] rounded-xl cursor-pointer w-full" +
          (error ? " border-ixRed" : "")
        }
      >
      ...
      {error && <span className="text-xs text-ixRed">{error}</span>}
    </div>
  );
};
