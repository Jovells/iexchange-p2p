...
const MerchantModal: React.FC<MerchantModalProps> = ({ hideModal, action }) => {
  ...
  return (
    <div className="w-full lg:w-[500px] h-auto bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md border-2 border-gray-500 dark:border-gray-700">
      <div className="flex justify-end">
        <X onClick={hideModal} className="cursor-pointer text-gray-700 dark:text-gray-300" />
      </div>
      {action === "verify" && (
        <>
          <div className="flex flex-col gap-6">
            <h2 className="text-gray-700 dark:text-gray-300 text-lg">Let’s Verify Your Identification</h2>
          ...
          <Button
            text="Proceed"
            className="bg-black dark:bg-gray-700 text-white hover:bg-gray-600 dark:hover:bg-gray-500 rounded-xl px-4 py-2 mt-12 w-full"
      ...
      {action === "stake" && (
        <>
          ...
          <Button
            text="Proceed"
            loading={isStaking}
            className="bg-black dark:bg-gray-700 text-white hover:bg-gray-600 dark:hover:bg-gray-500 rounded-xl px-4 py-2 mt-6 w-full"
            onClick={handleStake}
          />
        </>
      )}
