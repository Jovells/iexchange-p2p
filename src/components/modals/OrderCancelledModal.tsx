...
const OrderCancellationModal = ({ txHash }: { txHash: string }) => {
  ...
  return (
    <div className="w-[400px] bg-white p-14 rounded-[8px] flex flex-col justify-center items-center">
      ...
      <h2 className="font-[500px] text-center text-[16px] mb-6">Order Cancelled</h2>
      <p className="text-center text-gray-500 text[14px] font-[400px] mb-6">The other party has cancelled the order.</p>
