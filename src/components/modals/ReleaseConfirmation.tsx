        ...
        showModal(
            <div className='w-[400px] bg-white p-14 rounded-[8px] flex flex-col justify-center items-center'>
                ...
                <p className="text-center text-gray-500 text[14px] font-[400px] mb-6">
                    You have succesfully sold {cryptoAmount} for {fiatAmount}!
                </p>
                <p className="text-center text-gray-500 text[14px] font-[400px] mb-6">
                    You have succesfully sold {cryptoAmount} for {fiatAmount}!
                </p>
                <div className="text-gray-500">TxHash :</div> <a href={`${currentChain?.blockExplorers?.default.url}/tx/${txHash}`} target="_blank" className="text-blue-500">{shortenAddress(txHash, 8)}</a>
    ...
    return (
        <div className='w-[400px] bg-white rounded-[8px]'>
            <div className="flex flex-row justify-between items-center border-b border-gray-200 font-[500px] p-6 px-10">
                <h2 className='font-[500px] text-[16px]'>Relase Confirmation</h2>
                <X />
            </div>
            <div className="p-6 px-10 flex flex-col gap-4">
                ...
                <p className='text-gray-500 font-[400px] text-[14px]'>
                Ensure that the payment has been fully received in your account. Once you confirm the payment, the cryptocurrency will be released to the buyer. This action cannot be undone. 
                </p>
