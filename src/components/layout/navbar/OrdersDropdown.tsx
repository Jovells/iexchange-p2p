  ...
  return (
    <div className="w-full rounded-[8px] border border-gray-200 dark:border-gray-800">
      <div className="flex flex-row justify-between items-center p-4 border-b border-gray-200 dark:border-gray-800">
        <h2 className="text-grey-800 text-sm dark:text-white font-bold">Pending Orders</h2>
        <Link
      ...
      {myOrders ? (
        ...
        <div className="p-4 text-center text-gray-500 dark:text-gray-400">No Pending Orders</div>
      )}
    </div>
  );
}
